...
public class MainController implements Initializable {
    ...
    @FXML
    private ListView tbvSongsInPlayList;
    @FXML
    ...
    public void handlePlaylistNew() {
        ...
        // TODO Move stage.show() down here, use showAndWait() instead, and clear+re-add all observable PlayLists to update the list?
    }
